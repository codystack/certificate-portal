<?php
/**
 * Pedestal Crane (Starboard) "Certificate of Thorough Examination" → HTML for Dompdf.
 * $c['details'] = ['equipment' => [...], 'checklist' => [key => [result, comment]]].
 */
function render_pedestal_crane_starboard_template(array $c, array $def, string $qr): string
{
