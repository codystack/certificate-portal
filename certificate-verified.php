                        ...
                        <div class="card-body mt-3">
                            <div class="text-center mb-4">
                                ...
                                <div class="text-center mt-4">
                                    <div class="">
                                        <img src="assets/images/barcode.png">&nbsp; <span><?php echo htmlspecialchars($_SESSION['certNum'], ENT_QUOTES, 'UTF-8'); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3 mb-3 text-center">
                                <div class="col-md-6 col-lg-6">
                                    <div class="d-flex align-items-start">
                                        <div class="flex-grow-1 mb-3">
                                            Title<br />
                                            <strong>
                                                <?php echo htmlspecialchars($_SESSION['title'], ENT_QUOTES, 'UTF-8'); ?>
                                            </strong>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="d-flex align-items-start">
                                        ...
                                        Client's Name<br />
                                            <strong>
                                                <?php echo htmlspecialchars($_SESSION['client'], ENT_QUOTES, 'UTF-8'); ?>
                                            </strong>
                                        </div>
                                    </div>
                                </div>
